...
import { ArrowRight, Sparkles, Target, Users, Zap, Check, BarChart2, Lightbulb, Shield } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">
              Our AI platform transforms recruitment with automation and insights.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border border-gray-100">
              ...
              <h3 className="text-base lg:text-lg font-bold text-gray-800 mb-2 lg:mb-3">AI-Powered Matching</h3>
            ...
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border border-gray-100">
              ...
              <h3 className="text-base lg:text-lg font-bold text-gray-800 mb-2 lg:mb-3">Smart Assessment</h3>
              <p className="text-xs lg:text-sm text-gray-600">
            ...
            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border border-gray-100">
              ...
              <h3 className="text-base lg:text-lg font-bold text-gray-800 mb-2 lg:mb-3">Lightning Fast</h3>
              <p className="text-xs lg:text-sm text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">Talent Sourcing</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    We systematically identify and engage with top talent using advanced sourcing techniques.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">Candidate Assessment</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    Comprehensive evaluation of skills, experience, and cultural fit through our proven methodology.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">Strategic Matching</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    AI-powered matching aligns candidate strengths with your specific role requirements.
                  </p>
                </div>
              </div>
            ...
            <div className="relative rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent flex items-end p-6">
                <div>
                  <h3 className="text-white font-semibold text-lg">Proven Methodology</h3>
                  <p className="text-gray-200 text-sm mt-1">Delivering quality candidates since 2015</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Tech Startup Reduced Hiring Time by 60%</h3>
                <p className="text-sm text-gray-600 mb-4">
                  "RecruitInn helped us scale our engineering team from 10 to 50 in just 3 months. Their AI matching saved us hundreds of hours in screening."
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Enterprise Company Improved Retention by 45%</h3>
                <p className="text-sm text-gray-600 mb-4">
                  "The cultural fit assessment from RecruitInn has dramatically improved our employee retention and team cohesion."
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">HR Director, Fortune 500</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Our platform analyzes thousands of data points to provide actionable insights that optimize your hiring strategy and predict candidate success.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Our AI models continuously improve based on feedback and outcomes, ensuring better matches over time.
                  </p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-6 leading-relaxed">
                At <strong className="text-blue-600">Zillions</strong>, we're driven by a passion for connecting exceptional talent with visionary companies. Our commitment goes beyond just filling positions - we're dedicated to building lasting partnerships.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-800">Right Talent, Right Time</h3>
                    <p className="text-sm text-gray-600">
                      We provide personnel with the perfect blend of skills and attitude to fuel your business growth.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-800">Employee Development</h3>
                    <p className="text-sm text-gray-600">
                      We enrich candidates through development initiatives that enhance their skills and drive higher achievements.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-800">Strategic HR Solutions</h3>
                    <p className="text-sm text-gray-600">
                      We deliver initiatives that act as catalysts to accelerate your business performance.
                    </p>
                  </div>
                </div>
              </div>
